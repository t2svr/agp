...
\begin{document}
    ...
    \begin{figure}[!htbp]
        \centering
        \includesvg[width=\textwidth]{\figpath meme_structure.svg}
    ...
    \end{figure}
        ...
        \begin{figure}[!htbp]
            \centering
            \includesvg{\figpath process.svg}
        ...
        %     \centering
        \lstinputlisting[float, language=C++, caption=Code of a simple emulator program]{\codepath minimal_sys.rs}
        %\end{minipage}
